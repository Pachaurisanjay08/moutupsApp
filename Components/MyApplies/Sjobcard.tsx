...
const Sjobcard: React.FC<JobCardProps> = ({
  ...
  return (
    <View style={tw`bg-[#E7FAFE] p-4 rounded my-2 mx-4`}>
      <View style={tw`flex-row items-center mb-2 `}>
                  ...
                  />
                      <View   style={tw `flex-col ml-2`} >
                          <Text style={tw`text-[18px]  text-[#383e4d] font-semibold`}>{title}</Text>
      ...
      <Text style={tw`text-gray-400  mt-2`}>{postedTime}</Text>
      <View style={tw`flex-row  mx-20 justify-between` }>
